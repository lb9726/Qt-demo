...
public:
    ...
    void retranslateUi(QDialog *CertificateInfo)
    {
        ...
        label->setText(QApplication::translate("CertificateInfo", "Certification Path", 0));
        label_2->setText(QApplication::translate("CertificateInfo", "Certificate Information", 0));
    } // retranslateUi
