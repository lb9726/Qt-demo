...
#include "../../network/network-chat/peermanager.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_PeerManager_t, stringdata) + ofs \
...
void *PeerManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PeerManager.stringdata))
