...
public:
    ...
    {
        BearerMonitor->setWindowTitle(QApplication::translate("BearerMonitor", "BearerMonitor", 0));
        systemState->setTitle(QApplication::translate("BearerMonitor", "System State", 0));
        onlineStateLabel->setText(QApplication::translate("BearerMonitor", "Online State:", 0));
        onlineState->setText(QString());
        groupBox->setTitle(QApplication::translate("BearerMonitor", "Configurations", 0));
        configurationNameLabel->setText(QApplication::translate("BearerMonitor", "Name:", 0));
        configurationName->setText(QString());
        configurationStateLabel->setText(QApplication::translate("BearerMonitor", "State:", 0));
        configurationState->setText(QString());
        configurationTypeLabel->setText(QApplication::translate("BearerMonitor", "Type:", 0));
        configurationType->setText(QApplication::translate("BearerMonitor", "Invalid", 0));
        configurationPurposeLabel->setText(QApplication::translate("BearerMonitor", "Purpose:", 0));
        configurationPurpose->setText(QApplication::translate("BearerMonitor", "Unknown", 0));
        configurationIdentifierLabel->setText(QApplication::translate("BearerMonitor", "Identifier:", 0));
        configurationIdentifier->setText(QString());
        configurationRoamingLabel->setText(QApplication::translate("BearerMonitor", "Roaming:", 0));
        configurationRoaming->setText(QString());
        configurationChildrenLabel->setText(QApplication::translate("BearerMonitor", "Children:", 0));
        configurationChildren->setText(QString());
        nlaGroup->setTitle(QApplication::translate("BearerMonitor", "Network Location Awareness", 0));
        registerButton->setText(QApplication::translate("BearerMonitor", "Register", 0));
        unregisterButton->setText(QApplication::translate("BearerMonitor", "Unregister", 0));
        newSessionButton->setText(QApplication::translate("BearerMonitor", "New Session", 0));
        deleteSessionButton->setText(QApplication::translate("BearerMonitor", "Delete Session", 0));
        scanButton->setText(QApplication::translate("BearerMonitor", "Scan", 0));
        progressBar->setFormat(QApplication::translate("BearerMonitor", "%p%", 0));
        QTreeWidgetItem *___qtreewidgetitem = treeWidget->headerItem();
        ___qtreewidgetitem->setText(0, QApplication::translate("BearerMonitor", "1", 0));
        sessionGroup->setTitle(QApplication::translate("BearerMonitor", "Sessions", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("BearerMonitor", "Session 1", 0));
    } // retranslateUi
