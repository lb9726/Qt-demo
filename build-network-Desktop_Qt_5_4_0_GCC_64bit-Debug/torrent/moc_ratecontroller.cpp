...
#include "../../network/torrent/ratecontroller.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_RateController_t, stringdata) + ofs \
...
void *RateController::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RateController.stringdata))
