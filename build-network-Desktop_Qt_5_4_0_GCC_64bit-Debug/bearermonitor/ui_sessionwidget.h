...
public:
    ...
    {
        SessionWidget->setWindowTitle(QApplication::translate("SessionWidget", "Session Details", 0));
        sessionIdLabel->setText(QApplication::translate("SessionWidget", "Session ID:", 0));
        sessionId->setText(QString());
        sessionStateLabel->setText(QApplication::translate("SessionWidget", "Session State:", 0));
        sessionState->setText(QApplication::translate("SessionWidget", "Invalid", 0));
        configurationLabel->setText(QApplication::translate("SessionWidget", "Configuration:", 0));
        configuration->setText(QString());
        bearerLabel->setText(QApplication::translate("SessionWidget", "Bearer:", 0));
        bearer->setText(QString());
        interfaceNameLabel->setText(QApplication::translate("SessionWidget", "Interface Name:", 0));
        interfaceName->setText(QString());
        interfaceGuidLabel->setText(QApplication::translate("SessionWidget", "Interface GUID:", 0));
        interfaceGuid->setText(QString());
        lastErrorLabel->setText(QApplication::translate("SessionWidget", "Last Error:", 0));
        lastError->setText(QString());
        errorStringLabel->setText(QApplication::translate("SessionWidget", "Error String:", 0));
        errorString->setText(QString());
        rxData->setText(QApplication::translate("SessionWidget", "0", 0));
        txData->setText(QApplication::translate("SessionWidget", "0", 0));
        label_3->setText(QApplication::translate("SessionWidget", "Active Time:", 0));
        activeTime->setText(QApplication::translate("SessionWidget", "0 seconds", 0));
        openSessionButton->setText(QApplication::translate("SessionWidget", "Open", 0));
        openSyncSessionButton->setText(QApplication::translate("SessionWidget", "Blocking Open", 0));
        closeSessionButton->setText(QApplication::translate("SessionWidget", "Close", 0));
        stopSessionButton->setText(QApplication::translate("SessionWidget", "Stop", 0));
    } // retranslateUi
