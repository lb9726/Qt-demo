...
#include "../../network/bearermonitor/sessionwidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SessionWidget_t, stringdata) + ofs \
...
const QMetaObject SessionWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_SessionWidget.data,
      qt_meta_data_SessionWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SessionWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SessionWidget.stringdata))
