...
#include "../../network/googlesuggest/searchbox.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SearchBox_t, stringdata) + ofs \
...
void *SearchBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SearchBox.stringdata))
