...
#include "../../network/threadedfortuneserver/fortuneserver.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_FortuneServer_t, stringdata) + ofs \
...
void *FortuneServer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FortuneServer.stringdata))
